...
import { CreateOfframpProviderDto, CreateOfframpRequestDto, ListOfframpProviderDto, ProviderActionDto } from './dto/index';
...
export class OfframpController {
  ...
  @Get('/providers')
  //TODO: fix any
  listProviders(@Query() query?: ListOfframpProviderDto): Promise<any> {
  ...
  @Get()
  //TODO: fix any
  findAllOfframpRequests(): Promise<any> {
